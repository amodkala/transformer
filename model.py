...
class TransformerClassifier(nn.Module):
    def __init__(self, embeddings, d_model, nhead, num_encoder_layers,
                 num_classes, dropout=0.0, transformer_dropout=0.0, device=None):
        super(TransformerClassifier, self).__init__()
        self.embedding = nn.EmbeddingBag.from_pretrained(torch.tensor(embeddings, dtype=torch.float32), freeze=False)
